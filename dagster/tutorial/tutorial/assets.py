...
@asset # step 3: add the asset decorator to tell Dagster this is an asset
def topstory_ids() -> None: # step 2: turn it into function
...
# how to create a dagster assets
# 1. write your function/business logic
# 2. turn it into function
# 3. add the @asset decorater
